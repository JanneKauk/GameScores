        ...
        return (
            <div className={styles.loginMenu} style={divStyle}>
                ...
                <form onSubmit={login} style={{margin: "0.5rem 0 1.5rem 0", display: "grid"}}>
                    ...
                    <input type={"text"} placeholder="ILikeTrains58" onChange={e => setUser(e.target.value)} ref={usernameRef} /><br/>
                    <label style={{textAlign:"left", margin:"0.5rem 0 0 0"}}>Password</label>
                    <input type="password" placeholder="Something123" ref={pFieldRef} onChange={e => setPassword(e.target.value)} />
        ...
        return (
            <div className={styles.loginMenu} style={divStyle}>
                ...
                <form style={{margin: "0.5rem 0 1.5rem 0", display: "grid"}} onSubmit={registerHandler}>
                    ...
                    <input type={"email"} placeholder="email" onChange={e => setEmail(e.target.value)} ref={emailRef} /><br/>
                    <label style={{textAlign:"left"}}>Username</label>
                    <input type={"text"} placeholder="ILikeTrains58" onChange={e => setUser(e.target.value)} ref={usernameRef} /><br/>
                    <label style={{textAlign:"left", margin:"0.5rem 0 0 0"}}>Password</label>
                    <input type="password" placeholder="Something123" onChange={e => setPassword(e.target.value)} ref={pFieldRef} />
                    <label style={{textAlign:"left", margin:"0.5rem 0 0 0"}}>Repeat password</label>
                    <input type="password" placeholder="Something123" onChange={e => setConfirmPassword(e.target.value)} ref={confirmPasswordRef} />
